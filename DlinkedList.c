...
{
      struct client* pCur=pHead; //initializing pcurrent =phead to begin count from it
    for(int i=0;i<index;i++) //this loop is to reach for the pos. needed beginning from phead or ptail
    {
        pCur = pCur->pNext; //shifting
    }
